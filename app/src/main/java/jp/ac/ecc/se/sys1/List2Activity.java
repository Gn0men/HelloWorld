...
public class List2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText tuikaText = findViewById(R.id.tuikaText);
        Button tuikaButton = findViewById(R.id.tuikaButtton);
        ...
        // データ追加ボタン
        tuikaButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String tT = tuikaText.getText().toString();
                if (!tT.equals("")) {
                    // 1.追加する文字列を可変長配列に追加
                    dataList.add(tT);
                    // 2.リスト再表示
